...
| docs       | Documents TCP/IP Application in html format for offline viewing. Use [github pages](https://microchip-mplab-harmony.github.io/net_apps_sam_a5d2/) of this repository for viewing it online. |
...
|web_net_server_qspi_mpfs | [TCP/IP Secure WEB Server QSPI MPFS Application](apps/web_net_server_qspi_mpfs/readme.md)|
